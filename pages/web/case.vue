<template>
	<view class="case">
		<view class="uni-padding-wrap">
			<view class="page-section swiper">
				<view class="page-section-spacing">
					<swiper class="banner swiper" :style="{ height: windowHeight + 'px' }" :indicator-dots="indicatorDots" :autoplay="autoplay"
		...
		<view class="header">
			<view class="header-left">
				<view class="header-left-icon">
					<image :src="pictureInfo.store_logo"></image>
				</view>
		...
		<view class="bottom">
			...
			<button class="bottom-fx" type="button" @click="togglePopup('bottom-share')"><span class="icon wwi-icon wwi-icon-case-fenxiang"></span></button>
