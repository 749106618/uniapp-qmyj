		...
		<view class="wwiapp-order-list">
			...
			<view class="wwiapp-order-detail-block mt5">
				<view class="wwiapp-oredr-detail-add">
					...
					<view class="dl">
						<view class="dt">
							<view class="span">买家：</view>
							<view class="span strong">{{orderInfo.buyer_name}}</view>
						...
						<view class="wwiapp-order-item-con">
							...
							<view class="goods-subtotle">
								...
								<view class="dl">
									...
									<view class="dd"><view class="em">{{orderInfo.vr_indate}}</view></view>
								</view>
								<view class="dl t">
									<view class="dt">实付款</view>
									<view class="dd">￥<view class="em">{{orderInfo.order_amount}}</view></view>
								</view>
							</view>
						</view>
					</view>
					<view class="vr-code">
						<view class="title">电子兑换码</view>
						<view class="v-li flex flexJcs" v-for="(code,cc) in orderInfo.code_list" :key="cc">
							<view class="num">{{code.vr_code.substring(0,9)+'***'}}</view>
							<view class="desc">{{code.vr_code_desc}}</view>
						</view>
					</view>
			<view class="wwiapp-order-detail-block mt5">
				<view class="nul">
...
.vr-code{}
.vr-code .title{font-weight: 600; margin-left: 20upx; font-size: 32upx; line-height: 55upx;}
.vr-code .v-li{font-size: 28upx; background: #FdFdFd; padding: 10upx 20upx; margin-bottom: 10upx;}
.vr-code .v-li .num{color: #009A61;}
.vr-code .v-li .desc{color: #888888;}
</style>
