...
<view >
		<view class="input-group mt10">
			<view class="input-row border">
				<text class="title">发货人：</text>
				<input type="text" v-model="name" placeholder="请输入发货人姓名">
			...
			Inlimine() {
				this.wwiopt({
					...
					success: res => {
						...
						this.name=res.data.datas.address_info.seller_name;
						this.phone=res.data.datas.address_info.telphone;
