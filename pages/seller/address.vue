		...
		<view class="wwiapp-address-list">
			<view class="li" v-for="(item,index) in address_list" :key="index">
				...
				<view class="handle">
					...
					<view class="rt">
						<navigator :url="'/pages/seller/aeaddress?id='+item.address_id" class="a">
			...
			<navigator url="/pages/seller/aeaddress" class="btn-l">新增发货地址</navigator>
		</view>
		<navigator url="/pages/seller/aeaddress" class="wwi-icon wwi-icon-jiahao clearView"></navigator>
