<template>
	<view>
		...
		<view class="wwiapp-log-icon">
			<view class="icon-li color-hui"><view class="wwi-icon wwi-icon-qiaquan"></view><text>店铺代金券</text></view>
		...
		<view class="voucher-list">
			...
			<navigator :url="'/pages/my/voucherinfo?vid='+item.voucher_id" class="li" :class="{'ysy':item.voucher_state>'1'}" v-for="(item,index) in log_list" :key="index">
