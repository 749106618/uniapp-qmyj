      ...
      <view class="wwi-default-list">
		<view class="li border">
				<view class="a">
					...
					<view class="right">{{info.refund.refund_sn}}</view>
			</view>
		<view class="li border">
				<view class="a">
					<view class="h4">退款原因</view>
					</view>
					<view class="right">{{info.refund.reason_info}}</view>
			</view>
		<view class="li border">
				<view class="a">
					<view class="h4">退款金额</view>
					</view>
					<view class="right">{{info.refund.refund_amount}}</view>
			</view>
		<view class="li border">
				<view class="a">
					<view class="h4">退款说明</view>
					</view>
					<view class="right">{{info.refund.buyer_message}}
						</view>
			</view>
		<view class="li border">
				<view class="a">
      ...
      <view class="wwi-default-list">
		<view class="li border">
				<view class="a">
					...
					<view class="right">{{info.refund.seller_state}}</view>
			</view>
		<view class="li border">
				<view class="a">
					<view class="h4">商家备注</view>
				</view>
					<view class="right">{{info.refund.seller_message}}</view>
			</view>
		</view>	
      ...
      <view class="wwi-default-list">
		<view class="li border">
				<view class="a">
					...
					<view class="right">{{info.refund.admin_state}}</view>
			</view>
		<view class="li border">
				<view class="a">
					<view class="h4">平台备注</view>
				</view>
					<view class="right">{{info.refund.admin_message}}</view>
			</view>
		</view>	
