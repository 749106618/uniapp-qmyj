<template>
	<view class="serach">
		<view class="content-se" :style="{'border-radius':radius+'px'}">
			<!-- HM修改 增加进入输入状态的点击范围 -->
			<view class="content-box" :class="{'center':mode === 2}" @click="getFocus">
				<text class="wwi-icon wwi-icon-sousuo"></text>
				...
				<text v-if="isDelShow" class="wwi-icon wwi-icon-anniu_guanbi"  @click.stop="clear"></text>
			</view>
